				...
				thisWebview.webview.onDidReceiveMessage(
					async (data) => {
						...
						if (data.command) {
							...
							else if (data.command=='features') open('https://www.useblackbox.io/pricing?ref=tryvscode')
	...
	function getWebViewContent(page){
		...
		`
			...
			<body>
				...
				<div>
					<br><br><br>
					<p class="text-description"> Unlock access to all features on Blackbox. </p>
					<div class="btn-default btn-features">
						<span class="btn-features">Try for Free</span>
					</div>
				</div>
				<script>
					(function() {
